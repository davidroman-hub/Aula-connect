...
const Contact = ({ t }: MainComponentsProps) => {
  return (
          ...
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold mb-1">{t("main.contact.email")}</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold mb-1">{t("main.contact.phone")}</h4>
            ...
            <div className="mt-8">
              <h4 className="font-bold mb-4">{t("main.contact.follow")}</h4>
